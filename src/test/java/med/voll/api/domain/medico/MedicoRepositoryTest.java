...
@DataJpaTest
@AutoConfigureTestDatabase(replace= AutoConfigureTestDatabase.Replace.NONE)//Para não substituir o banco de dados padrão por um na memória
@ActiveProfiles("test")
class MedicoRepositoryTest {
    ...
    void escolherMeidicoAleatorioLivreNaDataCenario1() {
        //given ou arrange
        ...
        //when ou act
        var medicoLivre=medicoRepository.escolherMeidicoAleatorioLivreNaData(Especialidade.CARDIOLOGIA,proximaSegundaAs10);
    ...
    void escolherMeidicoAleatorioLivreNaDataCenario2() {
        //given ou arrange
        var proximaSegundaAs10= LocalDate.now().with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10,0);
